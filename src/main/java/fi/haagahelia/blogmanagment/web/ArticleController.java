...
public class ArticleController {
	...
	public String save(Article article, @RequestParam("file") MultipartFile file) {
		...
		if (!file.getOriginalFilename().isEmpty()) {
			// copy and save image
			/*
			 * try { // Get the file and save it in src/main/resources/static/img
			 * FileOutputStream output = new FileOutputStream(UPLOADED_FOLDER +
			 * file.getOriginalFilename()); output.write(file.getBytes());
			 * 
			 * //save filename in DB 
